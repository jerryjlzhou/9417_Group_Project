...
if model_t1 is not None:
    ...
    plt.title("Top feature importances for XGBoost CO classification (t+1) horizon")
    plt.xlabel("Importance")
    plt.tight_layout()

    fi_path = "xgboost_classification_plots/feature_importance_t+1.png"
    plt.savefig(fi_path, dpi=150)
    plt.show()
    print("Saved feature importance plot:", fi_path)
else:
    print("No t+1 model found; skipping feature importance plot.")